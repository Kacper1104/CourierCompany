...
public class Courier {
    private Integer id;
    private DistList lista_rozwozowa;
    ...
    public Courier(Integer id, DistList lista_rozwozowa, String login, String haslo, String imie_i_nazwisko) {
        this.id = id;
    ...
    public DistList getLista_rozwozowa() {
        return lista_rozwozowa;
    }
    public void setLista_rozwozowa(DistList lista_rozwozowa) {
        this.lista_rozwozowa = lista_rozwozowa;
    }
